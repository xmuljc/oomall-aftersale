...
open class RefundTranPo {
    ...
    open var userReceivedAccount: String? = null

    @Column(name = "pay_trans_id", columnDefinition = "int UNSIGNED not null")
    open var payTransId: Long? = null
