...
public class DivRefundTransDaoTest {
    ...
    void testFindByIdWhenObjectNotExist() {
        assertThrows(BusinessException.class,()->divRefundTransDao.findById(0L, 9999L));
    }
    ...
    void testFindByIdGivenWrongToken() {
        assertThrows(BusinessException.class,()->divRefundTransDao.findById(2L, 611L));
    }
    ...
    void testSaveGivenWrongObjectType() {
        ...
        payTrans.setId(12L);
        assertThrows(InvalidDataAccessApiUsageException.class,()->divRefundTransDao.update(payTrans));
    }
    ...
    void testInsertGivenWrongObjectType() {
        PayTrans payTrans = new PayTrans();
        payTrans.setId(12L);
        assertThrows(InvalidDataAccessApiUsageException.class,()->divRefundTransDao.insert(payTrans));
    }
}
