...
@Test
  ...
  @Test
    public void testGETProductIdGivenFound() throws Exception {
        ...
        Mockito.when(freightClient.getAllLogisticsById(10L,0, MAX_RETURN)).thenReturn(retFreight);
        Mockito.when(shopClient.getShopById(3L)).thenReturn(retObj);
        Mockito.when(shopClient.getTemplateById(3L,19L)).thenReturn(retTemplate);
