...
public class ShopProductController2Test {
    ...
    public void addOnsaleTest2()throws Exception{
        ...
        Mockito.when(shopClient.getShopById(10L)).thenReturn(retObj);
    ...
    public void delOnsaleIdTest2() throws Exception {
        ...
        Mockito.when(shopClient.getShopById(4L)).thenReturn(retObj);
    ...
    public void delOnsaleIdTest3() throws Exception {
        ...
        Mockito.when(shopClient.getShopById(9L)).thenReturn(retObj);
    ...
    public void getAllProductDraftTest1() throws Exception{
        ...
        shop.setId(10L);
        shop.setName("商铺10");
        Mockito.when(shopClient.getShopById(10L)).thenReturn(new InternalReturnObject<>(shop));
