...
import cn.edu.xmu.oomall.product.adaptor.listener.DeleteOnSaleConsumer;
...
public class ShopProductControllerTest {
    ...
    void testGetOnsaleByIdWhenNotExistCache() throws Exception{
        ...
        when(shopClient.getShopById(5L)).thenReturn(retObj);
    ...
    void testGetOnsaleByIdWhenExistCache() throws Exception{
        ...
        retObj.setErrmsg("成功");
        retObj.setData(shop);
        when(shopClient.getShopById(8L)).thenReturn(retObj);
