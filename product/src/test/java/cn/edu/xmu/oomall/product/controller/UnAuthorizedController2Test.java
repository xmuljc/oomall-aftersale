...
public class UnAuthorizedController2Test {
   ...
   @Test
    public void testGetProductSkuListGivenSuccess()throws Exception{
       ...
       Mockito.when(searchClient.searchProductsByNameAndBarcodeAndShopId(Mockito.eq("欢乐家久宝桃罐头"), Mockito.anyString(), Mockito.anyLong(), Mockito.anyInt(), Mockito.anyInt())).thenReturn(ret);
   ...
   /* *
    ...
    public void testGetProductProdGivenSuccess()throws Exception{
        ...
        Mockito.when(shopClient.getShopById(Mockito.any())).thenReturn(retObj);
        Mockito.when(shopClient.getTemplateById(Mockito.any(),Mockito.any())).thenReturn(retTeplate);
