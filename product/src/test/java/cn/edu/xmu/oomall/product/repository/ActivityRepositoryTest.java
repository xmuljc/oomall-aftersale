...
public class ActivityRepositoryTest {
    ...
    public void findByIdTestGivenA5(){
        ...
        Activity activity = activityRepository.findById(5L,2L,"couponActDao");
    ...
    public void findByIdTestGivenNoShop(){
        Mockito.when(redisUtil.hasKey("A5")).thenReturn(false);
        Mockito.when(redisUtil.set(Mockito.anyString(), Mockito.any(), Mockito.anyLong())).thenReturn(true);
        assertThrows(BusinessException.class, () ->  activityRepository.findById(5L,3L,"couponActDao"));
    }
    ...
    public void findByIdTestGivenWrongAct(){
        Mockito.when(redisUtil.hasKey("A5")).thenReturn(false);
        Mockito.when(redisUtil.set(Mockito.anyString(), Mockito.any(), Mockito.anyLong())).thenReturn(true);
        assertThrows(BusinessException.class, () ->  activityRepository.findById(5L,2L,"grouponActDao"));
    }
    ...
    public void findByIdTestGivenLimitMax(){
        ...
        Mockito.when(redisUtil.set(Mockito.anyString(), Mockito.any(), Mockito.anyLong())).thenReturn(true);
        assertThrows(BusinessException.class, () ->  activityRepository.findById(1000000L,2L,"couponActDao"));
    }
