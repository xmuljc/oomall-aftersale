...
public class OnsaleDaoTest {
    ...
    public void findByIdTestGivenO4(){
        ...
        OnSale onsale = onsaleRepository.findById(4L,3L);
    ...
    public void findByIdTestGivenNoEqual(){
        ...
        assertThrows(BusinessException.class, () -> onsaleRepository.findById(4L,20L));
    }
    ...
    public void findByIdTestGivenNoExist(){
        ...
        Mockito.when(redisUtil.set(Mockito.anyString(), Mockito.any(), Mockito.anyLong())).thenReturn(true);
        assertThrows(BusinessException.class, () -> onsaleRepository.findById(20L,10000000L));
    }
